...
{   ArrayList<Shape> done = new ArrayList();
    ArrayList<Shape> undone = new ArrayList();
...
//    private ArrayList<Shape> copy(ArrayList<Shape> x1) throws CloneNotSupportedException {
//        ArrayList<Shape> arr = new ArrayList<>();
//        int i = 0;
//        for (i = 0; i < arr.size(); i++) {
//            arr.add((Shape) arr.get(i).clone());
//            
//        }
//        return arr;
//    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        c.mode = 0;
        c.currentColor = jColorChooser1.getColor();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
     if(done.isEmpty()) return;
        ...
        repaint();
        undone.add(done.get(done.size()-1));
        done.remove(done.size()-1);
        for (Classes.Shape s : done) {
            if(s.circle){
                s.draw();
            } else{
            g.setColor(s.color);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        c.mode = 12;        // TODO add your handling code here:
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        c.mode = 13;        // TODO add your handling code here:
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
       if(undone.isEmpty()) return;
        Graphics g = c.getGraphics();
        done.add(undone.get(undone.size()-1));
        if(undone.get(undone.size()-1).circle){
                undone.get(undone.size()-1).draw();
            } else{
            g.setColor(undone.get(undone.size()-1).color);
            g.drawPolygon(undone.get(undone.size()-1));
            }
